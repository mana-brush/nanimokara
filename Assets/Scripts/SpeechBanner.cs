...
public class SpeechBanner : MonoBehaviour
{
    ...
    private readonly Dictionary<SpeakerSpeech, string[]> _speakerSpeeches = new ()
    {
        ...
        {SpeakerSpeech.TutorialStage3, new []{ "You made it past the gate! Awesome!", "There's another locked gate, but you can't move this block.", "Try pressing <space> when the yellow target appears, oh the block to the left, to SWAP your value." }},
